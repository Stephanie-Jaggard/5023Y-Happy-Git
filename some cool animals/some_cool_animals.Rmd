...
![Photo: Courtesy of The Mandolorian](img/Grogu.jpg)

##### Baby Yoda fun facts: 

- Also known as "The Child"
- Likes unfertilised frog eggs and control knobs
- Strong with the force

```{r}

usethis::use_git_config(user.name = "Stephanie-Jaggard", user.email = "uau21rju@uea.ac.uk")

```

```{r}
gitcreds::gitcreds_set(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)
```
----------
